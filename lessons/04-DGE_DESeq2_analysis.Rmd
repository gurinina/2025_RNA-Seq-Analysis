...
First we create a DESeqDataSet as we did in the count normalization chapter lesson and specify the location of our raw counts and metadata, and input our design formula:
...
# These were matched in the chapter 'Count normalization'
