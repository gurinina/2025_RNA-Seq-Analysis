...
**Exercise/Homework:** First save a copy of **`lessons/07-DGE_summarizing_workflow.Rmd`** in your student_notes folder as <lastname>_07-DGE_summarizing_workflow.Rmd. Then modify the file to analyze the MOV dataset, starting with Mov10_full_counts.txt in your data folder. Compare the "MOV10_knockdown" to the "control". Include a heatmap and a volcano plot**. points = +6
