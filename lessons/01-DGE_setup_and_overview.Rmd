...
Biological replicates vs Sequencing depth

More biological replicates → better estimates of biological variability → more statistical power to detect real differences
More sequencing depth → better precision for individual measurements but doesn't help with biological inference

The key insight: You can sequence one sample to infinite depth, but you still only have n=1 for statistical testing. DESeq2 and other tools require biological replicates to estimate variance and perform statistical tests.
