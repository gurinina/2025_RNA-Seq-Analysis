...
#### Loading libraries; technically we don't need to load all of these libraries because they are in the file scripts/setup.R which is sourced in the first .Rmd of the module. However, it's good practice to load them all at the beginning of your script.
```{r, message = FALSE}
...
# Try the group plot with the filtered data
emapplot(
  pwt_filtered,
  showCategory = 15,
  node_label = "none",
