...
> **FMRP** is the Fragile X Messenger Ribonucleoprotein. Loss of **FMRP** causes **Fragile X Syndrome (FXS)**, characterized by intellectual disability and autism spectrum disorder. **FMRP** regulates translation by binding to mRNAs and interacting with components of the microRNA pathway.

> **MOV10** usually facilitates translation suppression through the miRNA pathway. **MOV10-FMRP** interactions can either enhance this suppression or, when the **MOV10-FMRP** complex binds in proximity to **microRNA response elements (MREs)**, can sterically block **AGO2** access and translation is no longer suppressed.

![Alt text](img/model_mov10.png){ width=400 }

Model for **MOV10-FMRP** Cooperation in microRNA-Mediated Translation Regulation

Top: **MOV10** helicase unwinds G-rich structures in 3′ UTRs, exposing **microRNA response elements (MREs)** for **AGO2/RNA-induced silencing complex (RISC)** binding and gene silencing by translational repression.
