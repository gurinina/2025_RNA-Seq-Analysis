...
The jar = all genes tested (the “background”).

The red balls = genes that belong to a specific GO term.

You “draw” the genes that are significant in your analysis.
...
### Example how to do this in R

Suppose your background has \( N = 20,000 \). Out of these, \( m = 500 \) genes are associated with "cell cycle regulation." You have \( k = 1000 \)  differentially expressed genes, and \( q = 50 \) of them are associated with "cell cycle regulation."
